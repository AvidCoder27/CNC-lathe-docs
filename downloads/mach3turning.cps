...
description = "Mach3 Turning for Boxford Dueti Turn & Mill CNC Lathe";
vendor = "Artsoft + Wheaton HS Students";
...
// This factor is 1 in radius mode and 2 in diameter mode. Usually radius mode.
var xFormat = createFormat({decimals:(unit == MM ? 3 : 4), forceDecimal:true, scale:1});
